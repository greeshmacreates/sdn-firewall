# CN SDN Project - SDN-Based Firewall

Software-Defined Networking (SDN) controller with firewall management capabilities.
...
- `controller/` - Core controller modules
  - `firewall.py` - Firewall implementation
  - `rules.py` - Firewall rules management
- `logs/` - Log files
...
## Test Results
See [results/TEST_RESULTS.md](results/TEST_RESULTS.md) for complete test documentation.
